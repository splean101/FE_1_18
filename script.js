...
//2.
alert(`You have extra bonus! Your total salary was: ${firstMonthSalary + secondMonthSalary}$
It's  increase for 1$ and now it is ${firstMonthSalary + secondMonthSalary + 1}$`);
